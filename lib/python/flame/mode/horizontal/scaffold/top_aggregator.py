...
class TopAggregator(BaseTopAggregator):
    ...
    def internal_init(self) -> None:
        ...
        # second cache is added for C_WEIGHTS messages (same shape as the model)
        self.c_cache = Cache()
        self.c_cache.reset("size_limit", 1e15)
        self.c_cache.reset("cull_limit", 0)
    ...
    def _aggregate_weights(self, tag: str) -> None:
        ...
        for msg, metadata in channel.recv_fifo(channel.ends()):
            ...
            if MessageType.C_WEIGHTS in msg:
                c_weights = weights_to_model_device(msg[MessageType.C_WEIGHTS], self.model)
